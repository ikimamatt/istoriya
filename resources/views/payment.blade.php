...
<body class="animsition">
    ...
    <div style="background-color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); border-radius: 15px; margin: 0 auto; margin-bottom: 40px; margin-top: 40px; padding: 20px; width: 50%;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="file" name="payment_proof" style="width: 100%; color: #333; background-color: #f9f9f9; border: 1px solid #ccc; border-radius: 5px; padding: 10px; box-shadow: inset 0 1px 3px rgba(0, 0, 0, 0.1);">
