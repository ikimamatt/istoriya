						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td class="column-2">Aren Latte</td>
									<td class="column-3">Rp25.000</td>
									<td class="column-4 text-center">2</td>
									<td class="column-5">Rp50.000</td>
								</tr>
							</table>
						</div>
                    ...
                    <div class="bor10 p-lr-20 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                        ...
                        <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                            ...
                            <div class="flex-grow bor8 bg0 m-b-12" style="margin-left: 10px;">
                                <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="nama" placeholder="Masukkan Nama Anda">
                            </div>
                        </div>
                        ...
                        <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                            ...
                            <div class="flex-grow bor8 bg0 m-b-12" style="margin-left: 10px;">
                                <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="email" placeholder="Masukkan Email Anda">
                            </div>
                        </div>
                        <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                            <div class="size-208">
                            ...
                            <div class="flex-grow bor8 bg0 m-b-12" style="margin-left: 10px;">
                                <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="notelp" placeholder="Masukkan Nomor Telepon Anda">
                            </div>
                        </div>
                        ...
                        <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                            ...
                            <div class="flex-grow bor8 bg0 m-b-12" style="margin-left: 10px;">
                                <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="nama" placeholder="Masukkan Alamat Anda">
                            </div>
                        </div>
