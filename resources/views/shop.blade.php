		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="{{ asset('assets/images/logos/logo1.jpg') }}" class="logo">
						<img src="assets/images/logos/logo1.jpg" alt="IMG-LOGO">
					</a>
		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".pastry">
						Pastry Dessert
					</button>
				</div>
			...
			<div class="row isotope-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item pastry">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item pastry">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									 Cucumber Salad Logan (Crabstick)
								</a>
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="images/product-detail-01.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="assets/images/coffee/arenlatte.png" alt="Aren Latte">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/aren-latte.jpg">
                    ...
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="p-t-33">
                            <div class="p-b-10">
                                ...
                                <textarea class="form-control" placeholder="Masukkan permintaan Anda..."></textarea>
                            </div>
